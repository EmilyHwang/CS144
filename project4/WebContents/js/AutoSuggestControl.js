 ...
 */
AutoSuggestControl.prototype.autosuggest = function (oThis /*control object*/, bTypeAhead /*:boolean*/) {
	return function(){
		if(oThis.xmlHttpReq.readyState == 4){
			//make sure there's at least one suggestion
			var aSuggestions = [];
			var xmlSuggestions = oThis.xmlHttpReq.responseXML.getElementsByTagName('CompleteSuggestion');
			
			for(var i = 0; i < xmlSuggestions.length; i++) {
				var suggestion = xmlSuggestions[i].childNodes[0].getAttribute("data");
...
AutoSuggestControl.prototype.createDropDown = function () {
	...
	document.getElementById("queryDiv").appendChild(this.layer);
...
AutoSuggestControl.prototype.requestSuggestions = function (bTypeAhead /*:boolean*/) {
    ...
    if (sTextboxValue.length > 0){
		...
		this.xmlHttpReq.open("GET", request);
		this.xmlHttpReq.onreadystatechange = this.autosuggest(this, bTypeAhead);
